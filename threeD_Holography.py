import threeD_functions as myfunc
...
if __name__ == "__main__":
    ...
    Iin, g, Voc = myfunc.loadFEKO("Four_blocks")
    ground = myfunc.get_ground_truth()
    ...
    Tvec, Tmat = myfunc.voc_to_Tvec(Voc_holed)
    ...
    Tvec2, Tmat2 = myfunc.voc_to_Tvec(Voc_filled)
